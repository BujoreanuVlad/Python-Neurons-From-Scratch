...
optimizer = SGDOptimizer(1, 0.001, 0.8)

dense1 = DenseLayer(2, 64, activation=ReLU)
#dense_inter = DenseLayer(64, 64, activation=ReLU)
...
for epoch in range(numEpochs):
 ...
 #   output_inter = dense_inter.forward(output1)
  ...
  #  dense_inter.backward(dense2.dinputs)
    dense1.backward(dense2.dinputs)

    optimizer.preOptimize()
    optimizer.optimize(dense1)
   # optimizer.optimize(dense_inter)
